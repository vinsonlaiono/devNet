...
// @desc    Return a list of all profiles
// @access  Public
router.get('/', async (req, res) => {
    try {
        ...
        res.json(profiles);
        //  Working of building route to fetch all profiles.
    } catch (err) {
        console.error(err.message);
        res.status(500).send('Server error');
    }
